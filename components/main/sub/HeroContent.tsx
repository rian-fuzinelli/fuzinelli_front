...
const HeroContent = () => {
  return (
    ...
    className="Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9]">
        ...
        <h1 className="Welcome-text text-[13px]">Back-End Developer Portfolio</h1>
    </motion.div>
    ...
    className="flex flex-col gap-6 mt-6 text-6xl font-bold text-white max-w-[600px] w-auto h-auto">
        ...
        <motion.p variants={slideInFromLeft(0.8)} className="text-lg text-gray-400 my-5 max-w-[600px]">
            I&apos;m a Back-End Software Developer with experience in Website, 
            APIs, Database and Software Development. Check out my projects and skills.
        </motion.p>
